...
- `scripts/watch-codex-skills.ps1`: watch local skill changes and auto-run local sync only
...
This repo is prepared to run `scripts/watch-codex-skills.ps1` at logon through the Windows Startup folder. The watcher debounces file changes, mirrors `~/.codex/skills` into `skills/`, and commits updates locally. Push to GitHub manually when you want.
